...
# CHANGE BY JYOTI - 11-Sep-2026: START - Email OTP backend for HVISMP website
# ============================================================
# CONTACT EMAIL OTP
# ============================================================
...
def _send_contact_otp_email(
    ...
    subject = (
        "HVISMP Email Verification Code"
    )
...
def request_demo_view(request):
    ...
    subject = "New HVISMP Enquiry"

    text_body = (
        "A new HVISMP enquiry request "
        "was submitted.\n\n"
        f"Submitted: {ts}\n"
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New website contact submission for HVISMP"
        text_body = "\n".join(
            [
                "New contact submission for HVISMP:",
...
def contact_block_submit(request):
    """
    Handles the HVISMP consulting/contact form.
    """
